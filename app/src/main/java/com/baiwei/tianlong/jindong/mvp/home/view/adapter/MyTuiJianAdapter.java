...
public class MyTuiJianAdapter extends RecyclerView.Adapter<MyTuiJianAdapter.TuiJianViewHolder>{
    ...
    private transient List<HomeBeans.TuijianBean.ListBean> list;
    private Context context;

    public MyTuiJianAdapter(List<HomeBeans.TuijianBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public class TuiJianViewHolder extends RecyclerView.ViewHolder {
        List<HomeBeans.TuijianBean.ListBean> list;
